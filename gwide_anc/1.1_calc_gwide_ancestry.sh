...
plink_file_name=$1
rfmix_results_dir=$2
rfmix_input_dir=$3  # genetic map & other unchanging inputs
    #TODO: does this need to be clarified better?
admix_dir=$4
out_dir=$5
...
bash calc_gwide_ancestry/create_admixture_input.sh \
...
Rscript calc_gwide_ancestry/calc_admixture_gwide_ancestry.R \
...
mkdir "${out_dir}"
Rscript calc_gwide_ancestry/merge_gwide_ancestry.R \
