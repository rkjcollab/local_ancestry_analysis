...
chr=$1
nr_samples=`wc -l ../data/intermediate/shapeit_output/chr20.samples`
...
cut -f2 -d' ' /gpfs/share/barnescaapa/caapa_local_ancestry/data/input/genetic_map_tgp/chr${chr}.txt | sort -k1 > tmp_chr${chr}_map_sorted.txt
cat /gpfs/share/barnescaapa/caapa_local_ancestry/data/input/tgp/chr${chr}.impute.legend | grep ^rs | sort -k2 > tmp_chr${chr}_tgp_sorted.txt
cat /gpfs/share/barnescaapa/caapa_local_ancestry/data/input/tgp/chr${chr}.impute.legend | grep ^rs | sort -k2 | cut -f2 -d' ' | uniq -u > tmp_chr${chr}_tgp_unique.txt
...
sed -e '1d'  /gpfs/share/barnescaapa/caapa_local_ancestry/data/input/tgp/chr${chr}.impute.legend | cut -f2 -d' '  | sed "s/^/${chr}:/" > \
                                                             tmp_chr${chr}_ref_snps.txt
paste tmp_chr${chr}_ref_snps.txt  /gpfs/share/barnescaapa/caapa_local_ancestry/data/input/tgp/chr${chr}.impute.hap > \
